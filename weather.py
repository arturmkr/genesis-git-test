...
def print_weather(weather_data: dict):
    ...
    print(f"Temp, °C: {round(weather_data['main']['temp'] - 273)}")
    print(f"Temp feels like, °C: {round(weather_data['main']['feels_like'] - 273)}")
    ...
    print(f"Visibility, km: {weather_data['visibility'] / 1000}")
